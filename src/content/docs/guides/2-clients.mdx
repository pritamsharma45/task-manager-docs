...
- You cannot edit a client linked to existing tasks. Doing so will throw an error and the user will need to delete all existing tasks associated with that client.
...
You can WhatsApp your client directly from the client page. You can also send them a message if they are not in your existing contacts list.
...
## Filters You can very easily search and filter your clients by clicking on the magnifying glass icon on the displayed table header.
